...
export default function DrumMachine() {
  ...
  return (
    <div id="drum-machine" className=" container border border-secondary border-end rounded-3 position-absolute top-50 start-50 translate-middle" style={{maxWidth:'45rem'}}>
     <div className="row align-items-start">
      <div id="display" className="col  text-center " style={{maxWidth:'15rem'}}> <strong> <p className="text-center fs-4 border border-secondary bg-dark text-light" style={{translate:'0 300%'}}>{instrumentPlaying}</p></strong></div>
